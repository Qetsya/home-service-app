          ...
          <div className="grid grid-cols-[65%,35%] p-2 m-[5rem_5rem] grid-rows-[fit-content(200px)">
            ...
            <div className="flex font-roboto items-start flex-col gap-5 bg-gradient-to-b from-white to-gray-200 h-full w-full pl-10">
              ...
              <div className="pb-10 text-left text-[#2e2929] font-roboto text-xl tracking-wide leading-relaxed w-11/12">
                ...
                accusamus architecto modi deleniti, ipsa vero voluptatem assumenda beatae vel illo quibusdam facere
                tenetur delectus suscipit. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Culpa reiciendis
                aliquam, excepturi enim ad alias quod corrupti quasi nulla blanditiis esse ab provident aliquid
                accusamus facilis quas fuga! Animi, voluptatibus.
              </div>
            </div>
